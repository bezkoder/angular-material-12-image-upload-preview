...
In this tutorial, I will show you way to build Multiple Images upload with Preview example using Angular Material 12 and FormData with Progress Bars.

![angular-material-12-image-upload-preview-example](angular-material-12-image-upload-preview-example.png)

Show upload status for each file:

![angular-material-12-image-upload-preview-example-upload-status](angular-material-12-image-upload-preview-example-upload-status.png)

For more detail, please visit:
> [Angular Material 12 Image upload with Preview example](https://bezkoder.com/angular-material-12-image-upload-preview/)
...
More practice:
> [Angular 12 & Bootstrap: Multiple Images upload with Preview example](https://bezkoder.com/angular-12-multiple-image-upload-preview/)
